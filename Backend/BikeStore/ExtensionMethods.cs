...
{
    public static T CopyPropertiesFrom<T>(this T target, object source) => CopyPropertiesFrom(target, source, null);
    ...
    public static void LogToConsole(this string msg) => Console.WriteLine($"{DateTime.Now:dd.MM.yyyy HH:mm:ss} {msg}");
}